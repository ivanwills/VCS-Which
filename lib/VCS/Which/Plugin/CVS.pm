...
VCS::Which::Plugin::CVS - <One-line description of module's purpose>

=head1 VERSION

This documentation refers to VCS::Which::Plugin::CVS version 0.1.
...
Description: Returns the pretty name for the CVS
